...
public class test8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soru = dao.soru_çekme_iki_secenek(vt, "test8");
    ...
    public void go_back(View view) {
        Intent intent = new Intent(test8.this, testler.class);
    ...
    public void next(View view) {
        if (nextbtn.getText().equals("Finish")) {
            ...
            if (counter.sonuç(sayaç, 10, 2) == 1) {
                result1.setText("DEMEK OKULU BU KADAR ÇOK SEVDİN. AKADEMİK KARİYERDE BAŞARILAR");
                sp8=this.getSharedPreferences("com.mseyda.cengometre", Context.MODE_PRIVATE);
                sp8.edit().putString("test8",getString(R.string.test8a)).apply();

            } else if (counter.sonuç(sayaç, 10, 2) == 2) {
                result1.setText("SEKTÖRE HEVESİNİ SEBEBİ ŞİMDİ ANLAŞILDI. SEKTÖR SENİN GİBİLERİNE MUHTAÇ.");
                sp8=this.getSharedPreferences("com.mseyda.cengometre", Context.MODE_PRIVATE);
                sp8.edit().putString("test8",getString(R.string.test8b)).apply();
