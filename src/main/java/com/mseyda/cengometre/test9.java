...
public class test9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soru = dao.soru_çekme_iki_secenek(vt, "test9");
    ...
    public void go_back(View view) {
        Intent intent = new Intent(test9.this, testler.class);
    ...
    public void next(View view) {
        if (nextbtn.getText().equals("Finish")) {
            ...
            if (counter.sonuç(sayaç, 10, 2) == 1) {
                result1.setText("KURUMLARLA ARAN İYİ DEMEK. SENİ DE BİR KURUMUN PARÇASI OLARAK GÖRMEK HOŞ OLACAK.");
                sp9=this.getSharedPreferences("com.mseyda.cengometre", Context.MODE_PRIVATE);
                sp9.edit().putString("test9",getString(R.string.test9a)).apply();


            } else if (counter.sonuç(sayaç, 10, 2) == 2) {
                result1.setText("SENİ GİDİ İDEALİST SENİ. ÇALIŞTIĞIN ŞİRKETİN BÜYÜDÜĞÜNÜ İZLEMEK EĞLENCELİ OLACAK.(KÜÇÜK FİRMA)");
                sp9=this.getSharedPreferences("com.mseyda.cengometre", Context.MODE_PRIVATE);
                sp9.edit().putString("test9",getString(R.string.test9b)).apply();
